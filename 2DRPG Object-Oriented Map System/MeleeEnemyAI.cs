...
{
    public class MeleeEnemyAI : Component, ITurnTaker
    {
        ...
        public MeleeEnemyAI(string name)
        {
            Name = name;
            _name = name;
            stunnedCounter = 0;
        ...
        Vector2 FindValidPosition(Vector2 originalPosition)
        {
        ...
        bool IsEnemyAtPosition(Vector2 position)
        {
            ...
            {
                if (obj.Tag == "enemy" || obj.Tag == "enemy2")
                {
                    if (obj == enemy)
                    {
